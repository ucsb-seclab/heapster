...
log = logging.getLogger("heapster.taint_tracking")
...
class TaintTracker(ExplorationTechnique):
    ...
    def step(self, simgr, *kargs, **kwargs):
        ...
        #log.debug("Current active in TT before step are {}".format(simgr.active))
        ...
        #log.debug("Current active in TT after step are {}".format(simgr.active))
